    ...
    <div class="container">
      <div class="flex flex-wrap">
        <div class="w-full self-center pl-4 pr-4 lg:w-1/2 lg:pr-10">
          ...
          <p class="mb-10 max-w-md text-slate-400">
            "Our nearby Volunteers are ready to collect!"
            <span class="mt-1 block text-secondary">- RFL.</span>
          </p>
          <button
      ...
      <div class="flex flex-wrap px-4">
        ...
        <div class="w-full self-center pl-4 pr-4 lg:w-1/2 lg:pl-10">
          ...
          <h2 class="mb-10 mt-4 text-justify text-lg font-light text-primary lg:text-xl">Get Paid to Recycle Right Now,
            100+ Volunteers within 10km from you ready to collect!</h2>
